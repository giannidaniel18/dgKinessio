...
const {logOut, signIn , signUp , renderSignUpForm , renderSignInForm, renderEditProfile, renderProfile, editProfile} = require('../controllers/users.controller')
...
router.post ('/users/editProfile/:id_user', isLoggedIn, editProfile)
